 ...
 * @author robinepple
 */
public class DeriveFunctionTest {
    
    private BusinessLogic bl;
    GuiMock view;
    private static final String TEST_FUNCTION_NAME = "test";
    private static final String TEST_FUNCTION = "5x^2+3x+2";
    private static final String TEST_FUNCTION_NAME_DERIVED = "test'";
    private static final String TEST_FUNCTION_DERIVED = "10.0x + 3.0";
    ...
    public void EditFunctionTest() throws FunctionParsingException {
        ...
        Assert.assertEquals(TEST_FUNCTION_NAME_DERIVED, function.getFunctionName());
        Assert.assertEquals(TEST_FUNCTION_DERIVED, function.getDisplayString());
        Assert.assertNotNull(function.getColor());
    }
}
